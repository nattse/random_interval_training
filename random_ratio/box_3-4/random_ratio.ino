...
long reward_prob = 10; // Percent chance of reward (0-100)
...
bool calculate_reward() {
  long rand_value = random(100);
  if (rand_value < reward_prob) {
    return true;
  }
  else {
    return false;
...
void waiting_active() {
  ...
  bool reward_calculation = calculate_reward();
