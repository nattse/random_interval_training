...
long fixed_interval = 60; // Number of seconds for the fixed-duration active period. Only the first lever press during this period will be rewarded.
...
void loop() {
  long wait_time = 10;
  waiting(wait_time);
  waiting_active(fixed_interval * 1000L);
}
